...
| Path               | Description                                           |
| ------------------ | ----------------------------------------------------- |
| `app.py`           | Streamlit frontend that provides the user interface   |
| `backend.py`       | FastAPI backend handling SQL operations               |
| `frontend.py`      | Streamlit logic for managing user interaction         |
| `test_db.py`       | Script for database testing and connection validation |
